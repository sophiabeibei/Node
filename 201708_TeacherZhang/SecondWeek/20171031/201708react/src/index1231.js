...
//档给React元素添加属性的时候,属性名称跟原生的HTML不一样;要用驼峰命名法;
//有些特殊的属性比如class=>className; for=>htmlFor
//The `style` prop expects a mapping from style properties to values, not a string
//style属性期待一个样式对象的映射,而非字符串
//react渲染出来的任何的字符串都要经过转译,所以显示是没有问题的;

let msg = "<script>while(true){}</script>";//->死循环
let element1 = <div>
    {{msg}}
...
//React元素 element1 就是大名鼎鼎的虚拟DOM
//其实就是一个普通的JS对象,但是可以用来描述真实DOM长什么样子;
//type props (children)
ReactDOM.render(
    element1,
